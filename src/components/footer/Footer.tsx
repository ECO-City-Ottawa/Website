      ...
      <div className="container-app grid gap-10 py-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-text-normal">
            <li><Link href="#" className="hover:text-text-strong">Volunteer</Link></li>
            <li><Link href="#" className="hover:text-text-strong">Join a PAL</Link></li>
            <li><Link href="#" className="hover:text-text-strong">Partner with us</Link></li>
            <li><Link href="#" className="hover:text-text-strong">Donate</Link></li>
            <li><Link href="#" className="hover:text-text-strong">Start a CSP</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-text-normal">
            <li><Link href="#" className="hover:text-text-strong">About OBEC</Link></li>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-text-normal">
            ...
            <li><Link href="#" className="hover:text-text-strong underline">Contact us</Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-black/5">
        <div className="container-app flex flex-col items-center justify-between gap-3 py-6 text-sm text-text-normal md:flex-row">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link href="#" className="hover:text-text-strong">Privacy policy</Link>
            <Link href="#" className="hover:text-text-strong">Terms of service</Link>
            <Link href="#" className="hover:text-text-strong">Cookie settings</Link>
          </div>
        </div>
      </div>
    </footer>
