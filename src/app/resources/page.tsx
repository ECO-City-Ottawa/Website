        ...
        <section className="bg-[#061D2F] py-20 w-full text-center relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link href="/contact" className="bg-white text-[#0A1D2E] hover:bg-gray-100 px-8 py-3 rounded-lg font-bold text-base transition-colors shadow-sm">
                {t('resources.cta.btn1')}
              </Link>
              <Link href="/contact" className="border border-white/30 text-white hover:bg-white/10 px-8 py-3 rounded-lg font-bold text-base transition-colors">
                {t('resources.cta.btn2')}
              </Link>
            </div>
          </div>
        </section>
