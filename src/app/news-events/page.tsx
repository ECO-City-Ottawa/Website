...
export default function NewsEventsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'news' | 'events' | 'calendar'>('news');
  ...
  return (
    <>
      ...
      <main id="main" className="min-h-screen bg-white pb-20">
        ...
        <section id="subscribe" className="bg-[#061D2F] py-16 w-full text-center relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 max-w-md mx-auto">
              <input
                ...
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-white text-sm"
              />
              <button className="w-full sm:w-auto bg-white text-[#061D2F] hover:bg-gray-100 px-6 py-3 rounded-lg font-bold text-sm transition-colors whitespace-nowrap">
