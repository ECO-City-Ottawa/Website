...
export default function PageHero({
  ...
  return (
    <section className="relative w-full py-12 md:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden isolate">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
